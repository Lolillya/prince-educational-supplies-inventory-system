...
const CustomersPage = () => {
	...
	return (
		<section
			className={`flex h-screen max-h-screen w-screen flex-col gap-3 overflow-y-scroll p-10 pb-0`}
		>
			...
			<div className="flex h-auto gap-10 overflow-hidden">
					...
					<div className="mt-2 flex flex-col overflow-y-scroll pr-5">
						{filteredCustomers?.map((customer) => (
							<Card
								...
								className={`flex cursor-pointer flex-col gap-3 p-7 transition-transform ${selectedCustomer?.Personal_Details_Id ===
						...
						{selectedCustomer ? (
							<div className="flex flex-col gap-5">
								...
								<div className="flex h-auto w-full flex-col">
									<div className="flex items-center justify-between">
										<Label className="text-textGray">Invoices</Label>
