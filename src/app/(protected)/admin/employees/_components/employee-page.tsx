...
import { Search, Pencil, ListFilter } from "lucide-react";
...
const EmployeePageUI = ({
  ...
  const selectedEmployee = filteredEmployees?.find(
    (employee) => employee.employee_id === expandedCardId,
  );
            ...
            {filteredEmployees?.map((employee) => (
              <Card
                ...
                className={`flex cursor-pointer flex-col gap-3 p-7 transition-transform ${
                  expandedCardId === employee.employee_id
                    ? "bg-gray-300"
                    : "bg-white"
            ...
            {selectedEmployee ? (
              <div className="flex flex-col gap-5">
                ...
                <div className="flex flex-col gap-1">
                  ...
                  <span>
                    {selectedEmployee.personal_details.location?.address_line ||
                      "N/A"}
                  </span>
                  <span>
                    {selectedEmployee.personal_details.location?.city || "N/A"}
                  </span>
                  <span>
                  ...
                  <span>
                    {selectedEmployee.personal_details.location?.postal_code ||
                      "N/A"}
                  </span>
                </div>
                <div className="flex flex-col gap-1">
