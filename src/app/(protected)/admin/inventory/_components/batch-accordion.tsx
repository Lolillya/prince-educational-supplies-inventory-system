              ...
              <AccordionTrigger className="px-4 hover:no-underline">
                <p>
                  ...
                  {batchVariants.length > 0 ? (
                      batchVariants
                          .filter((batchVariant) => batchVariant.variant_id === selectedVariantId)
                        ...
                        batchVariants
                            ...
                            .map((batchVariant, index) => {
                              ...
                              return supplierUnits.map((supplierUnit, rateIndex) => {
                                const conversionRate = supplierUnit?.ConversionRate || [];
                                const price = supplierUnit?.price || "N/A";
                                const quantityPerUnit = supplierUnit?.quantity_per_unit || "N/A";
                                    ...
                                    <TableRow key={rateIndex}>
                                      ...
                                      <TableCell>
                                        {conversionRate.length > 0 ? (
                                            ...
                                            <span className="text-textGray">No Conversion Available</span>
                                        )}
                                      </TableCell>
                                      <TableCell>
