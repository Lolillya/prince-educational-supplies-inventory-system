...
import variantsData from "~/server/db/variantsData"; // Import the inventory data
...
const InventoryPage = () => {
  ...
  const handleExpandClick = (e: React.MouseEvent, id: number) => {
    e.stopPropagation(); // Prevent click from triggering DialogTrigger
    toggleExpand(id);
  };

  return (
      <section className={`h-auto w-screen p-5 ${poppins.className} m-10 mb-0 flex flex-col gap-3 overflow-y-scroll`}>
            ...
            <Dialog>
              ...
              <DialogContent className="w-full max-w-5xl gap-5 p-10">
                ...
                <div className="flex gap-3">
                  ...
                  <div className="flex w-full flex-col gap-1">
                    <Label>Unit <span className="text-red-600">*</span></Label>
                    <Input placeholder="Unit" className="p-5" required/>
                  </div>
                </div>

                <div>
                  <Textarea placeholder="About this product..." rows={4} className="resize-none bg-gray-100"/>
                </div>
                ...
                <div>
                  ...
                  <div className="relative bg-gray-100 p-8 rounded-lg border border-gray-300">
                    <div className="flex gap-8 mb-6 pr-12">
                      <div className="flex w-full flex-col gap-2">
                        <Label className="text-gray-500 font-medium">Description</Label>
                        <Input placeholder="Description"
                               className="p-4 bg-white border border-gray-300 rounded-lg shadow-sm" required/>
                      </div>

                      <div className="flex w-full flex-col gap-2">
                        <Label className="text-gray-500 font-medium">Stock</Label>
                        <Input placeholder="Stock" className="p-4 bg-white border border-gray-300 rounded-lg shadow-sm"
                               required/>
                      </div>
                    </div>
                    ...
                    <div className="flex gap-8 pr-12">
                      <div className="flex w-full flex-col gap-2">
                        <Label className="text-gray-500 font-medium">Wholesale Price</Label>
                        <Input placeholder="0000.00"
                               className="p-4 bg-gray-200 border border-gray-300 rounded-lg shadow-sm" required
                               disabled/>
                      </div>

                      <div className="flex w-full flex-col gap-2">
                        <Label className="text-gray-500 font-medium">Special Price</Label>
                        <Input placeholder="0000.00"
                               className="p-4 bg-gray-200 border border-gray-300 rounded-lg shadow-sm" required
                               disabled/>
                      </div>
                    ...
                    <button
                        className="absolute right-8 top-1/2 transform -translate-y-1/2 text-red-500 hover:text-red-700 text-2xl focus:outline-none">
                      &times;
                    </button>
                  </div>
                </div>
              ...
              <DialogContent className="w-full max-w-5xl gap-5 p-10">
                <DialogHeader>
                  <div className={"flex items-center gap-3"}>
                    ...
                    <label className={"text-red-400 text-lg"}>Back</label>
                  </div>
                </DialogHeader>
