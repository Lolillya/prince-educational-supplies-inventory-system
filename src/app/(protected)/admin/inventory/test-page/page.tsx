						...
						<div className="flex flex-col gap-3 pb-3 pr-3">
							{Array.isArray(inventoryItems) && inventoryItems.length > 0 ? (
								inventoryItems.map((item) => (
									<div
										className={`flex cursor-pointer items-center justify-between rounded-md border p-7 shadow-md transition-all duration-300 hover:bg-gray ${selectedItem?.inventory_id === item.inventory_id
											? "bg-gray"
											: ""
											}`}
