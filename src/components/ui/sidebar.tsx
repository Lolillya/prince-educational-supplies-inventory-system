      ...
      <section>
        ...
        <section className="mt-5 flex flex-col gap-3">
          <div
            ...
            className={`flex items-center rounded-lg p-2 hover:cursor-pointer hover:bg-white ${expanded ? "justify-start" : "justify-center"}`}
          >
            <Image src={Dashboard_Logo} alt="dashboard logo" />
            {expanded && (
              <Label className="ml-2 hover:cursor-pointer">Dashboard</Label>
            )}
          </div>
          ...
          >
            ...
            {expanded && (
              <Label className="ml-2 hover:cursor-pointer">Invoice</Label>
            )}
          </div>
        </section>
        ...
        <section className="mt-5 flex flex-col gap-3">
          ...
          <div
            ...
            className={`hover: flex cursor-pointer items-center rounded-lg p-2 hover:bg-white ${expanded ? "justify-start" : "justify-center"}`}
          >
            <Image src={Suppliers_Logo} alt="suppliers logo" />
            {expanded && (
              <Label className="ml-2 hover:cursor-pointer">Suppliers</Label>
            )}
          </div>
          ...
          >
            ...
            {expanded && (
              <Label className="ml-2 hover:cursor-pointer">Customers</Label>
            )}
          </div>
          ...
          >
            ...
            {expanded && (
              <Label className="ml-2 hover:cursor-pointer">Inventory</Label>
            )}
          </div>
          ...
          >
            ...
            {expanded && (
              <Label className="ml-2 hover:cursor-pointer">Staff</Label>
            )}
          </div>
          ...
          >
            ...
            {expanded && (
              <Label className="ml-2 hover:cursor-pointer">History</Label>
            )}
          </div>
        </section>
      </section>
